أعتذر عن سوء الفهم. تفضل هذا هو كود README.md بالكامل (بصيغة Markdown) جاهز للنسخ واللصق مباشرة في مستودعك على جيت هب (GitHub) أو موقع PyPI.
لقد صممت الملف باللغة الإنجليزية ليكون احترافياً ومتوافقاً مع المعايير العالمية لنشر المكتبات، ودمجت فيه المثال الشامل بدون أي تعليقات:
# CRCODUI
